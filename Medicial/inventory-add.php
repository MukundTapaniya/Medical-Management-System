...
<body>
    ...
    <center>
        <div class="head" style="margin-top:100px;border-radius: 30px;background:linear-gradient(#141e30, #243b55);color: white;box-shadow: 0 15px 25px rgba(7, 205, 240, 0.6);">
            <h2> <u>ADD MEDICINE DETAILS</u></h2>
        </div>
    </center>
            ...
            <form action="<?= $_SERVER['PHP_SELF'] ?>" method="post">
                <div class="column">
                    <p>
                        ...
                        <input type="number" name="medid" style="border-radius: 10px;">
                    </p>
                    <p>
                        <label for="medname">Medicine Name:</label><br>
                        <input type="text" name="medname" style="border-radius: 10px;">
                    </p>
                    <p>
                        <label for="qty">Quantity:</label><br>
                        <input type="number" name="qty" style="border-radius: 10px;">
                    </p>
                    <p>
                        <label for="cat">Category:</label><br>
                        <select id="cat" name="cat"  style="border-radius: 10px;">
                ...
                <div class="column">
                    ...
                    <p>
                        ...
                        <input type="number" step="0.01" name="sp" style="border-radius: 10px;">
                    </p>
                    <p>
                        <label for="loc">Location:</label><br>
                        <input type="text" name="loc" style="border-radius: 10px;">
                    </p>
                </div>


                <input type="submit" name="add" value="Add Medicine" style="border-radius: 15px;background:linear-gradient(#141e30, #243b55);color: white;box-shadow: 0 15px 25px rgba(7, 205, 240, 0.6);">
            </form>
            <br>
