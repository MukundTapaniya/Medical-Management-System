...
<body>
    ...
    <center>
        ...
        <div class="head" style="margin-top:100px;border-radius: 30px;background:linear-gradient(#141e30, #243b55);color: white;box-shadow: 0 15px 25px rgba(7, 205, 240, 0.6);">
            ...
            <h2><img src="./img/chemist.png" style="height:50px;width:50px;"> CHEMIST DASHBOARD</h2>
        </div>
    </center>
    <style>
        img:hover {
    ...
    <a href="inventory-view.php" title="View Inventory">
        <img src="./img/inventory.png" style="padding:8px;margin-left: 450px;margin-top:120px;width:200px;height:200px;border:2px solid black; box-shadow: 0 8px 25px 0 rgba(71, 43, 229, 0.2), 0 8px 25px 0 rgba(71, 43, 229, 0.2);
    text-align: center; border-radius: 25px;" alt="Inventory"></a>

    <a href="salesreport.php" title="View Transactions">
        <img src="./img/moneyicon.png" style="padding:8px; margin-left: 40px;width:200px;height:200px;border:2px solid black; box-shadow: 0 8px 25px 0 rgba(71, 43, 229, 0.2), 0 8px 25px 0 rgba(71, 43, 229, 0.2);
    text-align: center; border-radius: 25px;" alt="Transactions List"></a>

    <a href="stockreport.php" title="Low Stock Alert">
        <img src="./img/alert.png" style="padding:8px;margin-left: 40px;width:200px;height:200px;border:2px solid black; box-shadow: 0 8px 25px 0 rgba(71, 43, 229, 0.2), 0 8px 25px 0 rgba(71, 43, 229, 0.2); border-radius: 25px;" alt="Low Stock Report">
    </a>
</body>
